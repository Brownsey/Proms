...
The hosted website is installer documentation only. It cannot read or control the loopback service, install software, or launch native programs. Do not claim setup is zero-install.
